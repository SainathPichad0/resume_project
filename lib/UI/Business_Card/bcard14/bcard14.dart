...
import 'pdf_api.dart';
import 'pdf_ui.dart';
class Bcard14 extends StatefulWidget {
  ...
  @override
  State<Bcard14> createState() => _Bcard14State();
}

class _Bcard14State extends State<Bcard14> {
  double h = 0.0, w = 0.0;
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Expanded(child: Text(widget.company,
                      style: TextStyle(
                          color: Colors.black,
