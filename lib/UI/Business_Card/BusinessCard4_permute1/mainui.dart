...
class BusinessCard4UIpermute1 extends StatefulWidget {
  String name;
  String email;
  String mainrole;
  String phone;
  ...
  @override
  _BusinessCard4UIpermute1State createState() => _BusinessCard4UIpermute1State();
}

class _BusinessCard4UIpermute1State extends State<BusinessCard4UIpermute1> {
  double h = 0.0, w = 0.0;
