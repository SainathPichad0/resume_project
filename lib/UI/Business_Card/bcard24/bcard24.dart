...
import 'package:my_resume/UI/Business_Card/BusinessCard1/pdf_api.dart';
...
class bcard24 extends StatefulWidget {
  ...
  @override
  State<bcard24> createState() => _bcard24State();
}
              ...
              child: Column(
                children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Icon(CupertinoIcons.phone, color: Colors.purple,
                                  size: 15,),
                            ...
                            Row(
                              ...
                              children: [
                                Icon(Icons.email, color: Colors.purple,size: 15,),
                  ...
                  Row(
                    ...
                    children: [
                      Icon(MdiIcons.officeBuilding, color: Colors.purple,),
                      Text(widget.address)
                    ],
                  )
