...
class BusinessCard7UI extends StatefulWidget {
  String name;
  String email;
  String mainrole;
  String phone;
  ...
  @override
  _BusinessCard7UIState createState() => _BusinessCard7UIState();
}

class _BusinessCard7UIState extends State<BusinessCard7UI> {
  double h = 0.0, w = 0.0;
