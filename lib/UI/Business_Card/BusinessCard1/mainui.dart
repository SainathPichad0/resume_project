...
class BusinessCard1UI extends StatefulWidget {
  String name;
  String email;
  String mainrole;
  String phone;
  ...
  @override
  _BusinessCard1UIState createState() => _BusinessCard1UIState();
}

class _BusinessCard1UIState extends State<BusinessCard1UI> {
  double h = 0.0, w = 0.0;
