...
class BusinessCard4UIpermute2 extends StatefulWidget {
  String name;
  String email;
  String mainrole;
  String phone;
  ...
  @override
  _BusinessCard4UIpermute2State createState() =>
      _BusinessCard4UIpermute2State();
}

class _BusinessCard4UIpermute2State extends State<BusinessCard4UIpermute2> {
  double h = 0.0, w = 0.0;
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          child: Text(
            role.toUpperCase(),
            style: TextStyle(fontSize: 12 * kh * h, color: Colors.black),
          ),
        ),
        SizedBox(
          height: h * 0.02,
