...
class ResumeUI6permute1 extends StatefulWidget {
  String name;
  String email;
  String phone;
  String linkedin;
  ...
  @override
  _ResumeUI6permute1State createState() => _ResumeUI6permute1State();
}

class _ResumeUI6permute1State extends State<ResumeUI6permute1> {
  double h = 0.0, w = 0.0;
          ...
          Row(
            children: [
              Container(
                ...
                //color: HexColor('#014281'),
                //color:HexColor('#8DB580'),
