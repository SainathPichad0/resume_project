...
class ResumeUI7permute3 extends StatefulWidget {
  String name;
  String email;
  String mainrole;
  String phone;
  ...
  @override
  _ResumeUI7permute3State createState() => _ResumeUI7permute3State();
}

class _ResumeUI7permute3State extends State<ResumeUI7permute3> {
  double h = 0.0, w = 0.0;
