...
class ResumeUI7permute1 extends StatefulWidget {
  String name;
  String email;
  String mainrole;
  String phone;
  ...
  @override
  _ResumeUI7permute1State createState() => _ResumeUI7permute1State();
}

class _ResumeUI7permute1State extends State<ResumeUI7permute1> {
  double h = 0.0, w = 0.0;
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                mainrole,
                style: TextStyle(fontSize: 17*kh*h, fontWeight: FontWeight.bold),
              ),
            ],
          ),
          Text(
