...
class ResumeUI7permute2 extends StatefulWidget {
  String name;
  String email;
  String mainrole;
  String phone;
  ...
  @override
  _ResumeUI7permute2State createState() => _ResumeUI7permute2State();
}

class _ResumeUI7permute2State extends State<ResumeUI7permute2> {
  double h = 0.0, w = 0.0;
  ...
  Widget introduction(String name, String email, String phone) {
    ...
    return Container(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(
          phone,
          style: TextStyle(color: Colors.pink, fontSize: 15 * kh * h),
        ),
        Text(
          email,
          style: TextStyle(
