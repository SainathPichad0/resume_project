...
class Resumepage12permute1 extends StatefulWidget {
  ...
  @override
  State<Resumepage12permute1> createState() => _Resumepage12permute1State();
}

class _Resumepage12permute1State extends State<Resumepage12permute1> {
  double h = 0.0, w = 0.0;
