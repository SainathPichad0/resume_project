...
class ResumeUI5permute2 extends StatefulWidget {
  String name;
  String email;
  String phone;
  String linkedin;
  ...
  @override
  _ResumeUI5permute2State createState() => _ResumeUI5permute2State();
}

class _ResumeUI5permute2State extends State<ResumeUI5permute2> {
  double h = 0.0, w = 0.0;
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      contacts(widget.email, widget.phone, widget.github,
                          widget.linkedin),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      workex(widget.roleincompany, widget.fromcompany,
                          widget.tocompany, widget.company, widget.aboutcompany)
                    ],
                  ),
                ),
              ],
  ...
  Widget workex(
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          title,
          style: TextStyle(fontSize: 15 * kh * h,color: Colors.lightBlue, fontWeight: FontWeight.bold),
        ),
        SizedBox(
          height: h * 0.01,
        ),
        Row(
          children: [
            ...
            Text(
              company,
              style:
                  TextStyle(fontSize: 12 * kh * h,color: Colors.lightBlue, fontWeight: FontWeight.bold),
            ),
          ],
        ),
        SizedBox(
