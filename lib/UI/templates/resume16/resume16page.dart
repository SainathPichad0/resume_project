...
Column(
  ...
  children: [
    ...
    Text("Tom Roberts",style: TextStyle(
        color: Colors.white,
      ...
      fontSize: 12
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                SocialRow_withicon(icon: Icons.email, val: "saipichad7@gmail.com"),
              ...
              child: Center(
                child: Row(
                  ...
                  children: [
                    ...
                    SocialRow_withicon(icon:MdiIcons.linkedin, val: "git.linkedinss.com"),

                    SocialRow_withicon(icon: MdiIcons.github, val: "git.coml.com"),
           ...
           Padding(
             ...
             child: Row(
               children: [
                 Expanded(
                   ...
                   children: [
                    ...
                    ,
                     ...
                     Text("Fugiat qui sit Lorem excepteur cillum id veniam commodo aliqua enim commodo. Enim deserunt id id nostrud eiusmod officia sunt. Sunt consectetur cupidatat fugiat occaecat velit reprehenderit voluptate est proident proident tempor aute mollit."
                 ...
                 Wrap(
                   children: [
                     Text("Manipal Institute Of Technology'",style: TextStyle(
                         fontSize: 11
                     ),)
                   ],
                 ),
