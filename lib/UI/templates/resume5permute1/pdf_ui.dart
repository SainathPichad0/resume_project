    ...
    child: Column(
      ...
      children: [
        Text(
          name.toUpperCase(),
          style: TextStyle(
              fontSize: 30, fontWeight: FontWeight.bold, letterSpacing: 2, color: PdfColors.pink,),
        ),
        SizedBox(
          height: h * 0.01,
        ),
...
Widget contacts(String email, String phone, String github, String linkedin) {
  return Padding(
    ...
    child: Column(
      ...
      children: [
        Container(
          child: Divider(color: PdfColors.pink, thickness: 1),
          width: w * 0.45,
        ),
        Container(
          child: Text(
...
Widget workex(
  ...
  return Column(
    ...
    children: [
      ...
      Text(
        title,
        style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold,color: PdfColors.pink),
      ),
      SizedBox(
        height: h * 0.01,
      ),
      Row(
        children: [
          ...
          Text(
            company,
            style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold,color: PdfColors.pink),
          ),
        ],
      ),
      SizedBox(
