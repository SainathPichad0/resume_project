...
import 'pdf_api.dart';
import 'pdf_ui.dart';
class ResumeUI4permute1 extends StatefulWidget {
  String name;
  String email;
  String phone;
  String linkedin;
  ...
  List<String> skillsList;
   ResumeUI4permute1({Key? key,required this.name,
    required this.email,
  ...
  @override
  _ResumeUI4permute1State createState() => _ResumeUI4permute1State();
}

class _ResumeUI4permute1State extends State<ResumeUI4permute1> {
  double h = 0.0, w = 0.0;
  @override
      ...
      children: [
        ...
        Column(
          ...
          children: [
            Text(
              name,
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: h*0.026341,color: Colors.brown),//20
            ),
            Text(
              occupation,
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: h*0.026341,color: Colors.brown),
            ),
            Row(
              children: [
                ...
                Text(
                  linkedin,
                  style: TextStyle(fontSize:h*0.019758 ,color: Colors.brown),//15
                ),
              ],
            ),
            Text(
              github,
              style: TextStyle(fontSize: h*0.019758,color: Colors.brown ),
            ),
            Text(
              email,
              style: TextStyle(fontSize:  h*0.019758,color: Colors.brown),
            ...
            Container(
              width: w * 0.7,
              child: const Divider(color: Colors.brown, thickness: 1),
            )
          ],
        )
      ],
      ...
      children: [
        ...
        Container(
          ...
          child: Text(
            desc,
            style: TextStyle(
              fontSize: h*0.019758,color: Colors.brown
            ),
          ),
        )
      ],
        ...
        Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  occupation,
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 0.02371*h,color: Colors.brown),
                ),
                SizedBox(
                  height: h * 0.0025,
                ),
                ...
                Text(
                  duties,
                  style: TextStyle(fontSize: h*0.01712,color: Colors.brown),
                )
              ],
            ))
      ],
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: Text(
            'Education',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 0.02634*h,color: Colors.brown),
          ),
        ),
        Container(
          width: w * 0.7,
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                college,
                style: TextStyle(fontSize:0.019756*h,color: Colors.brown),
              ),
              SizedBox(
                height: h * 0.0025,
              ),
