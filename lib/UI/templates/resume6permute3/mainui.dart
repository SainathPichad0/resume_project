...
class ResumeUI6permute3 extends StatefulWidget {
  String name;
  String email;
  String phone;
  String linkedin;
  ...
  @override
  _ResumeUI6permute3State createState() => _ResumeUI6permute3State();
}

class _ResumeUI6permute3State extends State<ResumeUI6permute3> {
  double h = 0.0, w = 0.0;
